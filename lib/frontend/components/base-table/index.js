...
class BaseTable extends Component {
  ...
  render () {
    ...
    return (<div className='is-relative'>
      <Sticky className='sticky-two is-fullwidth is-absolute'>
        <SimpleTable className={`is-transparent ${className}`}>
          <TableHead columns={columns} />
          <TableBody className='is-not-shown' data={data} columns={columns} />
          {this.getFoot()}
        </SimpleTable>
      </Sticky>
